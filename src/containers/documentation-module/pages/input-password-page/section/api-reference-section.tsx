...
import { apiRefInputPasswordList, apiRefTableColumnList } from "../constant"
...
const ApiReferenceSection = () =>{
    ...
    const apiRefInputPasswordData = useMemo<tableRowDataType[]>(()=>{
        return(apiRefInputPasswordList)
    },[])
    ...
    return(
        <>
            ...
            >
                <p className="text-title-lg"><span className="text-title-lg text-code">InputPassword</span></p>
                <p>Text input specifically function for inputing sensitive text.</p>
                <Table
                    tableColumn={apiRefTableColumn}
                    tableData={apiRefInputPasswordData}
                />
            </div>
        </>
    )
